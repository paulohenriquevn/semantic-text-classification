"""Domain-specific exception hierarchy for the Semantic Conversation Intelligence Engine.
...
class EngineError(Exception):
    """Base exception for all Semantic Conversation Intelligence Engine errors.

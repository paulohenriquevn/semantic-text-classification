"""CLI entrypoint for the Semantic Conversation Intelligence Engine.
...
@click.group()
def cli() -> None:
    """Semantic Conversation Intelligence Engine — CLI."""


@cli.command()
def version() -> None:
    """Show the engine version."""
    click.echo(f"semantic-conversation-engine {__version__}")
